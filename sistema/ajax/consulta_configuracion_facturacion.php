	...
	include("../conexiones/conectalogin.php");
		...
		$con = conenta_login();
	$configuracion_facturacion = new consulta_configuracion();
	...
	if (isset($_POST['opcion_mostrar']) && ($_POST['opcion_mostrar']=='inventario')){	
		...
		$consulta_configuracion=$configuracion_facturacion->consulta_configuracion_facturacion($ruc_empresa, $con, $serie_consultada);
	...
	class consulta_configuracion{
		...
		public function consulta_configuracion_facturacion($ruc_empresa, $con, $serie_consultada){	
		$consulta_configuracion = mysqli_query($con, "SELECT * FROM configuracion_facturacion WHERE ruc_empresa ='".$ruc_empresa."' and serie_sucursal ='".$serie_consultada."';");
