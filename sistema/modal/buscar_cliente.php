			<!-- Modal -->
			<div class="modal fade bs-example-modal-lg" id="agregarCliente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				  ...
				  <div class="modal-body">
					<form class="form-horizontal">
					  <div class="form-group">
						<div class="col-sm-6">
						 <input type="text" class="form-control" id="c" placeholder="Buscar cliente" onkeyup="load(1)">
						</div>
