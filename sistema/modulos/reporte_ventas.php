  ...
  <body>
    ...
    <div class="container-fluid">
		...
		<div class="panel-heading">		
			<h4><i class='glyphicon glyphicon-list-alt'></i> Reporte de ventas y Notas de crédito</h4>
		</div>

		<div class="panel-body">
			<form class="form-horizontal" method ="POST" target="_blank" action="../excel/reporte_ventas_excel.php">
					...
					<div class="col-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><b>Reporte</b></span>
								...
								<option value="3" > Detalle de facturas</option>
								<option value="2" > Notas de crédito</option>
								<option value="4" > Detalle NC</option>
								<option value="5" > Recibos de venta</option>
								</select>
...
function mostrar_reporte(){
 ...
 var vendedor = $("#vendedor").val();
	 ...
	 $.ajax({
			type: "POST",
			url: "../ajax/reporte_ventas.php",
			data: "action="+tipo_reporte+"&id_cliente="+id_cliente+"&id_producto="+id_producto+"&desde="+desde+"&hasta="+hasta+"&id_marca="+id_marca+"&vendedor="+vendedor,
