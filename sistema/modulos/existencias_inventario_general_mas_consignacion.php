...
<html lang="en">
  <head>
  <meta charset="utf-8">
  <title>Existencias + consignación</title>
...
<div class="container-fluid">  
    <div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-search'></i> Existencias de inventarios + consignaciones</h4>		
		</div>
		<div class="panel-body">
			<form class="form-horizontal" role="form" method ="POST" action="../excel/reporte_inventario_mas_consignacion.php" >
...
function load(page){
	...
	$("#loader").fadeIn('slow');
	$.ajax({
		url:'../ajax/buscar_existencias_inventarios.php?action=general_mas_consignaciones&page='+page+'&q='+q+"&ordenado="+ordenado+"&por="+por,
		 beforeSend: function(objeto){
...
$( "#editar_minimo" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			...
			data: parametros,
			 beforeSend: function(objeto){
				$("#resultados_ajax_editar_minimos").html("Guardando...");
			  },
