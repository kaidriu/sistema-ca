  ...
  <body>
    ...
    <div class="container-fluid">
		...
		<div class="panel-heading">		
			...
			<form class="form-horizontal" id="reporte_retenciones_compras" method ="POST" action="../excel/reporte_retenciones_compras.php" >
				<div class="form-group row">
					...
					<div class="col-md-1">
						<button type="button" class="btn btn-default" onclick ='reporte_retenciones_compras();'><span class="glyphicon glyphicon-search" ></span> Buscar</button>
					</div>
					<div class="col-md-1">							
...
function reporte_retenciones_compras(){
         ...
         data: 'action=reporte_retenciones_compras&parametro='+parametro,
