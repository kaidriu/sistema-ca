...
<head>
<title>Configurar proformas</title>
</head>
...
?>
	...
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-pencil'></i> Configuraciones varias en proformas</h4>
		</div>	
<!--Para preguntar si trabaja con inventarios las facturas-->		
		<div class="panel-body">
			<div class="well well-sm">
			<div class="panel-heading">Trabajar con inventario en las proformas.</div>
			...
			<div class="well well-sm">
			<div class="panel-heading">Mostrar listados al momento de agregar un producto a la proforma.</div>
			...
			<div class="well well-sm">
			<div class="panel-heading">Mostrar etiquetas en el pdf de la proforma impresa.</div>
...
$( "#guarda_trabajar_con_inventario" ).submit(function( event ) {
		$('#guardar_datos_inventario').attr("disabled", true);
		 var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					 url: '../clases/guarda_conf_proforma.php',
					data: parametros,
...
$(function(){
	...
	$('#serie_sucursal_trabaja_con_inventario').change(function(){
		...
		$.post( '../clases/guarda_conf_proforma.php', {opcion_consulta: 'aplica_inventario', serie_sucursal: serie_sucursal}).done( function( respuesta){
	...
	$('#serie_sucursal_productos_clientes').change(function(){
		...
		$.post( '../clases/guarda_conf_proforma.php', {opcion_consulta: 'productos_clientes', serie_sucursal: serie_sucursal}).done( function( respuesta){
	...
	$('#serie_sucursal_opciones_inventario').change(function(){
		...
		$.post( '../clases/guarda_conf_proforma.php', {opcion_consulta: 'opciones_inventario', serie_sucursal: serie_sucursal}).done( function( respuesta){
			$( '#resultados_clientes_productos' ).html( respuesta);
			var id_conf = $("#id_configuracion").val();
	...
	$('#serie_sucursal_mostrar_impresion').change(function(){
		...
		$.post( '../clases/guarda_conf_proforma.php', {opcion_consulta: 'impresion_etiquetas', serie_sucursal: serie_sucursal}).done( function( respuesta){
	...
	$('#serie_sucursal_salidas_inventario').change(function(){
		...
		$.post( '../clases/guarda_conf_proforma.php', {opcion_consulta: 'calculo_salida_inventario', serie_sucursal: serie_sucursal}).done( function( respuesta){
