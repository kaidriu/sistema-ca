...
?>
	...
	<body>
		...
		$con = conenta_login();
		$busca_vendedores = mysqli_query($con, "SELECT ven.id_vendedor as id_vendedor FROM vendedores as ven INNER JOIN usuarios as usu ON usu.cedula=ven.numero_id and ven.ruc_empresa='".$ruc_empresa."' WHERE usu.id = '" . $id_usuario . "' ");
		$row_vendedor = mysqli_fetch_array($busca_vendedores);
						...
						<div class="form-group">
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="hidden" class="form-control input-sm" name="vendedor" id="vendedor" value="<?php echo $id_vendedor; ?>">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="input-group">
	...
	<script>
		...
		function enviar_cxc_mail_individual(id) {
		...
		function enviar_cxc_mail_todos(id) {
			var mail_receptor = $("#mail_cliente" + id).val();
			$("#id_documento").val(id);
			$("#mail_receptor").val(mail_receptor);
