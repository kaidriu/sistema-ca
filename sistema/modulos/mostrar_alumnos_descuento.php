...
// PARA MOSTRAR LOS ESTUDIANTES A QUIENES SE LES VA A APLICAR LOS DESCUENTOS
	$sql_alumnos=mysqli_query($con, "SELECT * FROM alumnos WHERE ruc_empresa='$ruc_empresa' and sucursal_alumno = $sucursal_alumno_descuento and paralelo_alumno = $paralelo_alumno_descuento ");
	$numero=0;
...
$( "#guardar_descuentos" ).submit(function( event ) {
	 ...
	 var parametros = $(this).serialize();
			$.ajax({
         type: "POST",
         url: "../ajax/guardar_descuentos_alumnos.php",
         data: parametros,
