...
<div class="container-fluid">  
    <div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-search'></i> Existencias de inventarios por fecha de vencimiento</h4>		
		</div>
...
$(document).ready(function(){
	$.ajax({
		url:'../ajax/existencias_inventarios_tmp.php?action=fecha_caducidad',
...
function load(page){
	...
	$("#loader").fadeIn('slow');
	$.ajax({
		url:'../ajax/buscar_existencias_inventarios.php?action=fecha_caducidad&page='+page+'&q='+q+"&ordenado="+ordenado+"&por="+por,
		 beforeSend: function(objeto){
