...
<div class="container">  
    <div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-search'></i> Cargar proveedores</h4>		
		</div>
			...
			<div class="col-md-5">
				<div class="panel panel-info">
					<div class="table table-bordered">
					  <table class="table">
						<tr  class="info">
							<th colspan="2">Cargar proveedores desde excel</th>
						</tr>
						<tr>
				...
				<div class="panel panel-info">
					<div class="table table-bordered">
					  <table class="table">
						...
						<div class="form-group row">
						<td class="col-xs-1">
						<a href="../descargas/cargar_proveedores.xlsx" class="list-group-item list-group-item-warning" target="_blank"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Descargar archivo ejemplo </a>	
						</td>
						<td class="col-xs-1">
...
$(function(){
        $("#cargar_archivo").on("submit", function(e){
            ...
            $.ajax({			
                url: "../ajax/cargar_proveedores.php?action=cargar_proveedores",
                type: "post",
                dataType: "html",
                data: formData,
