		...
		<div class="panel-body">
				...
				<div class="form-group row">
					...
					<div class="col-md-2">
						...
						<option value="1">Facturas Ventas</option>
					...
					<div class="col-md-2">
						<button type="button" class="btn btn-primary" onclick='procesar_comp();'><span class="glyphicon glyphicon-cog" ></span> Generar  <span class="badge" id="count"></span></button>
...
<script>
  ...
  function search(){
		...
		var count = 0;
		$.ajax({
			url:'../ajax/buscar_comprobantes_para_descargar.php?action=buscar_comp&desde='+desde+'&hasta='+hasta+'&documento='+documento,
